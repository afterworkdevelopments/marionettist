...
(function(root, factory) {
  var $, Backbone, Marionette, _, e, i18n, s;
  root = typeof self === 'object' && self.self === self && self || typeof global === 'object' && global.global === global && global;
  if (typeof define === 'function' && define.amd) {
    return define(['underscore', 'jquery', 'backbone', "backbone.marionette", "i18next-client", 'exports', "underscore.string"], function(_, $, Backbone, Marionette, i18n, exports, s) {
      var Marionetist;
    ...
    return module.exports = root.Marionetist = factory(root, exports, Backbone, Marionette, _, $, i18n, s);
  } else {
    return root.Marionetist = factory(root, {}, root.Backbone, root.Marionette, root._, root.jQuery || root.Zepto || root.ender || root.$, root.i18n, root.s);
  }
})(this, function(root, exports, Backbone, Marionette, _, $, i18n, s) {
