...
(function(root, factory) {
  var $, Backbone, BackboneAssociations, BackboneRadio, Marionette, _, e, i18next, moment, momentRange, momentTimezone, numeral, s;
  root = typeof self === 'object' && self.self === self && self || typeof global === 'object' && global.global === global && global;
  if (typeof define === 'function' && define.amd) {
    return define(['underscore', 'jquery', 'backbone', 'backbone.radio', "backbone-associations", "backbone.marionette", "i18next", 'exports', "underscore.string", "numeral", "moment", "moment-range", "moment-timezone"], function(_, $, Backbone, BackboneAssociations, Marionette, i18next, exports, s, numeral, moment, momentRange, momentTimezone) {
      var Marionettist;
    ...
    return module.exports = root.Marionettist = factory(root, exports, Backbone, Marionette, _, $, i18next, s, numeral, moment);
  } else {
    return root.Marionettist = factory(root, {}, root.Backbone, root.Marionette, root._, root.jQuery || root.Zepto || root.ender || root.$, root.i18next, root.s, root.numeral, root.moment);
  }
})(this, function(root, exports, Backbone, Marionette, _, $, i18next, s, numeral, moment) {
  ...
  if (Backbone.Radio == null) {
    if (typeof console !== "undefined" && console !== null) {
      console.error("Unable to load Backbone.Radio");
    }
  }
  ...
  if (moment.tz == null) {
    if (typeof console !== "undefined" && console !== null) {
      console.error("Unable to load moment-timezone");
    }
  }
  ...
  Marionettist.setLocale = function(locale, callback) {
    var oldLocale;
    if (locale == null) {
      locale = "en";
    }
    ...
    return Marionettist.I18n.setLng(locale, function(t) {
